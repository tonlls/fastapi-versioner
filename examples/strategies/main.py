...
def get_products_v1_path():
    ...
    return [
        Product(**product, version="1.0 (URL Path)")
...
def get_products_v2_path():
    ...
    return [
        Product(**product, version="2.0 (URL Path)")
        for product in products_data
    ]
...
def get_products_v1_header():
    ...
    return [
        Product(**product, version="1.0 (Header)")
        for product in products_data
    ]
...
def get_products_v2_header():
    ...
    return [
        Product(**product, version="2.0 (Header)")
        for product in products_data
    ]
...
def get_products_v1_query():
    ...
    return [
        Product(**product, version="1.0 (Query)")
        for product in products_data
    ]
...
def get_products_v2_query():
    ...
    return [
        Product(**product, version="2.0 (Query)")
        for product in products_data
    ]
...
def get_products_v1_accept():
    ...
    return [
        Product(**product, version="1.0 (Accept)")
        for product in products_data
    ]
...
def get_products_v2_accept():
    ...
    return [
        Product(**product, version="2.0 (Accept)")
        for product in products_data
    ]
...
def get_products_v1_multi():
    ...
    return [
        Product(**product, version="1.0 (Multi)")
        for product in products_data
    ]
...
def get_products_v2_multi():
    ...
    return [
        Product(**product, version="2.0 (Multi)")
        for product in products_data
    ]
...
if __name__ == "__main__":
    ...
    print("\n# Accept header versioning")
    print("curl -H 'Accept: application/json;version=1.0' http://localhost:8000/products")
    print("curl -H 'Accept: application/json;version=2.0' http://localhost:8000/products")
