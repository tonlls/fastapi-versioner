...
from ..types.config import VersioningConfig, NegotiationStrategy
from ..types.compatibility import VersionNegotiator
...
class VersionManager:
    ...
    def get_version_info(self, version: Optional[VersionLike] = None) -> Dict[str, Any]:
        """
    ...
    def get_deprecation_info(self, version: VersionLike) -> Optional[Dict[str, Any]]:
        """
