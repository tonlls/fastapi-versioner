...
from ..types.deprecation import DeprecationInfo, DeprecationLike, normalize_deprecation_info
    ...
    def get_route_info(self) -> dict[str, Any]:
        ...
        if self.deprecation_info:
            info["deprecation"] = {
                ...
                "sunset_date": self.deprecation_info.sunset_date.isoformat() if self.deprecation_info.sunset_date else None,
...
class VersionRegistry:
    ...
    def get_route(self, path: str, method: str, version: Version) -> Optional[VersionedRoute]:
        """
    ...
    def get_latest_version(self, path: str, method: str) -> Optional[Version]:
        """
...
def version(
    ...
    **kwargs: Any
    ...
    def decorator(func: Callable) -> Callable:
        ...
        func._fastapi_versioner_routes.append(versioned_route)
        
        # Store the latest version info for easy access
        func._fastapi_versioner_version = version_obj
        func._fastapi_versioner_deprecated = deprecation_info is not None
        ...
        wrapper._fastapi_versioner_routes = func._fastapi_versioner_routes
        wrapper._fastapi_versioner_version = func._fastapi_versioner_version
        wrapper._fastapi_versioner_deprecated = func._fastapi_versioner_deprecated
...
def get_route_versions(func: Callable) -> List[Version]:
    ...
    if hasattr(func, "_fastapi_versioner_routes"):
        return [route.version for route in func._fastapi_versioner_routes]
    return []
...
def get_route_info(func: Callable) -> List[dict[str, Any]]:
    ...
    """
    if hasattr(func, "_fastapi_versioner_routes"):
        return [route.get_route_info() for route in func._fastapi_versioner_routes]
    return []
